...
if($action == "update"){
	...
	$update = 'UPDATE user_projects SET '.$fieldname.' = :fieldvalue WHERE project_id = :project_id AND roll_no = :roll_no';
	...
	$delete = 'DELETE FROM user_projects  WHERE project_id = :project_id AND roll_no = :roll_no';
